"""
Simplified Amrita College Chatbot Application
============================================

A streamlined Streamlit chatbot application for Amrita College, Coimbatore
with core functionality and clean interface.
...
Hostel warden name is Ravi Shanmugam, contact number is +91-9876543210
"""
...
def make_api_request(messages: List[Dict], api_key: str) -> Tuple[str, bool]:
    """
    Make API request to OpenRouter with proper error handling.
    ...
    Returns:
        Tuple[str, bool]: (response_content, success_flag)
    """
    headers = {
...
def display_typing_animation():
    """Display a typing animation effect."""
